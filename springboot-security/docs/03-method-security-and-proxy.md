...
- `springboot-security/src/main/java/com/learning/springboot/bootsecurity/AdminOnlyService.java`
- `springboot-security/src/main/java/com/learning/springboot/bootsecurity/SelfInvocationPitfallService.java`
