...
上一章：[第 148 章：自测题（Spring Core Resources）](../spring-core-resources/docs/appendix/148-99-self-check.md) ｜ 全书目录：[Book TOC](/book/) ｜ 下一章：[第 150 章：主线时间线：Spring Profiles](../spring-core-profiles/docs/part-00-guide/150-03-mainline-timeline.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 模块主线时间线（含可跑入口）：[`spring-core-profiles/docs/part-00-guide/03-mainline-timeline.md`](../spring-core-profiles/docs/part-00-guide/150-03-mainline-timeline.md)
