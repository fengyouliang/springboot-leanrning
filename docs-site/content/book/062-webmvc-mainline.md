...
上一章：[第 61 章：自测题（Spring Core Tx）](../spring-core-tx/docs/appendix/061-99-self-check.md) ｜ 全书目录：[Book TOC](/book/) ｜ 下一章：[第 63 章：主线时间线：Spring Boot Web MVC](../springboot-web-mvc/docs/part-00-guide/063-03-mainline-timeline.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 模块主线时间线（含可跑入口）：[`springboot-web-mvc/docs/part-00-guide/03-mainline-timeline.md`](../springboot-web-mvc/docs/part-00-guide/063-03-mainline-timeline.md)
