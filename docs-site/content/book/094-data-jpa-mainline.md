...
上一章：[第 93 章：99 - Self Check（springboot-security）](../springboot-security/docs/appendix/093-99-self-check.md) ｜ 全书目录：[Book TOC](/book/) ｜ 下一章：[第 95 章：主线时间线：Spring Boot Data JPA](../springboot-data-jpa/docs/part-00-guide/095-03-mainline-timeline.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 模块主线时间线（含可跑入口）：[`springboot-data-jpa/docs/part-00-guide/03-mainline-timeline.md`](../springboot-data-jpa/docs/part-00-guide/095-03-mainline-timeline.md)
