...
上一章：[第 165 章：自测题（Spring Core Validation）](../spring-core-validation/docs/appendix/165-99-self-check.md) ｜ 全书目录：[Book TOC](/book/) ｜ 下一章：[第 167 章：主线时间线：Spring Boot Actuator](../springboot-actuator/docs/part-00-guide/167-03-mainline-timeline.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 模块主线时间线（含可跑入口）：[`springboot-actuator/docs/part-00-guide/03-mainline-timeline.md`](../springboot-actuator/docs/part-00-guide/167-03-mainline-timeline.md)
