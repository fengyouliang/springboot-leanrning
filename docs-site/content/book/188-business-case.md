...
上一章：[第 187 章：99 - Self Check（springboot-testing）](../springboot-testing/docs/appendix/187-99-self-check.md) ｜ 全书目录：[Book TOC](/book/) ｜ 下一章：[第 189 章：主线时间线：Business Case（综合案例）](../springboot-business-case/docs/part-00-guide/189-03-mainline-timeline.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 模块主线时间线（含可跑入口）：[`springboot-business-case/docs/part-00-guide/03-mainline-timeline.md`](../springboot-business-case/docs/part-00-guide/189-03-mainline-timeline.md)
