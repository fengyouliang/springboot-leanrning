...
上一章：[第 50 章：99. 自测题：你是否真的理解了 weaving？](../spring-core-aop-weaving/docs/appendix/050-99-self-check.md) ｜ 全书目录：[Book TOC](/book/) ｜ 下一章：[第 52 章：主线时间线：Spring Core Tx（事务）](../spring-core-tx/docs/part-00-guide/052-03-mainline-timeline.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 模块主线时间线（含可跑入口）：[`spring-core-tx/docs/part-00-guide/03-mainline-timeline.md`](../spring-core-tx/docs/part-00-guide/052-03-mainline-timeline.md)
