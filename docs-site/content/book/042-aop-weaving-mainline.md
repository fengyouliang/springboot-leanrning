...
上一章：[第 41 章：99. 自测题：你是否真的理解了 AOP？](../spring-core-aop/docs/appendix/041-99-self-check.md) ｜ 全书目录：[Book TOC](/book/) ｜ 下一章：[第 43 章：主线时间线：AOP Weaving（织入：LTW/CTW）](../spring-core-aop-weaving/docs/part-00-guide/043-03-mainline-timeline.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 模块主线时间线（含可跑入口）：[`spring-core-aop-weaving/docs/part-00-guide/03-mainline-timeline.md`](../spring-core-aop-weaving/docs/part-00-guide/043-03-mainline-timeline.md)
