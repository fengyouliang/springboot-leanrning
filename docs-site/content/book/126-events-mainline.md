...
上一章：[第 125 章：99 - Self Check（springboot-async-scheduling）](../springboot-async-scheduling/docs/appendix/125-99-self-check.md) ｜ 全书目录：[Book TOC](/book/) ｜ 下一章：[第 127 章：主线时间线：Spring Events](../spring-core-events/docs/part-00-guide/127-03-mainline-timeline.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 模块主线时间线（含可跑入口）：[`spring-core-events/docs/part-00-guide/03-mainline-timeline.md`](../spring-core-events/docs/part-00-guide/127-03-mainline-timeline.md)
