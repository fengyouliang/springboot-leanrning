# 第 69 章：04：ExceptionResolvers（异常从哪来、又被谁“翻译”成状态码）
<!-- CHAPTER-CARD:START -->
!!! summary "章节学习卡片（五问闭环）"
...
- **安全链路（Security FilterChain）**
  ...
  - 参考：Security 与 MVC 相对位置（含边界 Lab）：[part-08-security-observability/01-security-filterchain-and-mvc.md](../part-08-security-observability/081-01-security-filterchain-and-mvc.md)
