...
上一章：[part-01-boot-basics/02-configuration-properties-binding.md](../part-01-boot-basics/02-configuration-properties-binding.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[appendix/99-self-check.md](99-self-check.md)
