...
The `boot-data-jpa` module SHALL include deep dive Labs and `@Disabled` Exercises that teach practical JPA mechanics, including:
...
- **WHEN** a learner runs `mvn -q -pl boot-data-jpa test`
