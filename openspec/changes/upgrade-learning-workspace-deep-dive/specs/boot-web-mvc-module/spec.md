...
The `boot-web-mvc` module SHALL include deep dive Labs and `@Disabled` Exercises that teach Spring MVC mechanics beyond basic controller mapping, including:
...
- **WHEN** a learner runs `mvn -q -pl boot-web-mvc test`
