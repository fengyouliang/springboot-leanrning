...
The workspace SHALL provide a capstone learning module named `boot-business-case` that demonstrates a realistic end-to-end flow and how Spring mechanics compose across concerns:
...
- **WHEN** a learner runs `mvn -q -pl boot-business-case test`
- **THEN** the tests pass and demonstrate the end-to-end flow with observable outcomes

#### Scenario: Run the capstone module
- **WHEN** a learner runs `mvn -pl boot-business-case spring-boot:run`
