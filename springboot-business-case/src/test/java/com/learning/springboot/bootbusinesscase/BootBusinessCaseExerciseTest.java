    ...
    void exercise_getOrderById() throws Exception {
        ...
        assertThat(result.getResponse().getStatus())
                .as("""
                        ...
                        - `springboot-business-case/src/test/java/com/learning/springboot/bootbusinesscase/BootBusinessCaseLabTest.java`
                        """)
                .isEqualTo(200);
    ...
    void exercise_checkedExceptionRollbackRule() {
        assertThat(true)
                .as("""
                        ...
                        建议阅读：
                        - `spring-core-tx/docs/03-rollback-rules.md`
                        - `spring-core-tx/docs/01-transaction-boundary.md`
                        """)
                .isFalse();
    }
    ...
    void exercise_selfInvocationPitfall() {
        assertThat(true)
                .as("""
                        ...
                        - `spring-core-tx/docs/02-transactional-proxy.md`
                        """)
                .isFalse();
    }
    ...
    void exercise_transactionalEventAfterRollback() {
        assertThat(true)
                .as("""
                        ...
                        建议阅读：
                        - `spring-core-events/docs/07-transactional-event-listener.md`
                        """)
                .isFalse();
    }
}
