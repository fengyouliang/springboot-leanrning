...
上一章：[第 146 章：06. jar vs filesystem：为什么在 IDE 里 OK，打包后就不行？](../part-01-resource-abstraction/146-06-jar-vs-filesystem.md) ｜ 全书目录：[Book TOC](/book/) ｜ 下一章：[第 148 章：自测题（Spring Core Resources）](148-99-self-check.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 建议：读取文本时显式使用 UTF-8（见 [05. reading-and-encoding](../part-01-resource-abstraction/145-05-reading-and-encoding.md)）
