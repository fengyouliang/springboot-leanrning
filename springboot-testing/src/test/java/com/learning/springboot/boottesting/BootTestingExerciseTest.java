    ...
    void exercise_webMvcValidation() {
        assertThat(true)
                .as("""
                        ...
                        - `springboot-testing/src/test/java/com/learning/springboot/boottesting/GreetingControllerWebMvcLabTest.java`
    ...
    void exercise_sliceVsFull() {
        assertThat(true)
                .as("""
                        ...
                        参考：
                        - `springboot-testing/src/test/java/com/learning/springboot/boottesting/GreetingControllerWebMvcLabTest.java`
                        - `springboot-testing/src/test/java/com/learning/springboot/boottesting/GreetingControllerSpringBootLabTest.java`
