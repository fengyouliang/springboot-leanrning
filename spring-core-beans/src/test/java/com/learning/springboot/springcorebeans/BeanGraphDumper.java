...
final class BeanGraphDumper {

    private BeanGraphDumper() {
    }

    static String dumpCandidates(ConfigurableListableBeanFactory beanFactory, Class<?> requiredType) {
    ...
    static String dumpDependencies(ConfigurableListableBeanFactory beanFactory, String beanName) {
