...
> 对应完整版本（AOP 模块）：
>
> - AOP 容器主线（AutoProxyCreator/Advisor/Advice/Pointcut）：`spring-core-aop/docs/07-autoproxy-creator-mainline.md`
> - 多切面/多代理叠加与顺序：`spring-core-aop/docs/09-multi-proxy-stacking.md`
...
对应 Lab/Test：`spring-core-beans/src/test/java/com/learning/springboot/springcorebeans/SpringCoreBeansProxyingPhaseLabTest.java`
