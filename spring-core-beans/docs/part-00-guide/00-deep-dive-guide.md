...
把 [01. Bean 心智模型](../part-01-ioc-container/01-bean-mental-model.md) 的三层模型落到源码，最小可以这么映射：
...
这个练习跑通后，你再去看 [06. Post Processors](../part-01-ioc-container/06-post-processors.md) / [12. 容器启动与基础设施](../part-03-container-internals/12-container-bootstrap-and-infrastructure.md) / [14. Post-Processor 排序](../part-03-container-internals/14-post-processor-ordering.md) / [31. 代理发生的阶段](../part-04-wiring-and-boundaries/31-proxying-phase-bpp-wraps-bean.md) / [16. 提前引用与循环依赖](../part-03-container-internals/16-early-reference-and-circular.md) / [15. 预实例化短路](../part-03-container-internals/15-pre-instantiation-short-circuit.md)，会非常顺。
