...
上一章：[part-00-guide/01-quickstart-30min.md](01-quickstart-30min.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-ioc-container/01-bean-mental-model.md](../part-01-ioc-container/01-bean-mental-model.md)
