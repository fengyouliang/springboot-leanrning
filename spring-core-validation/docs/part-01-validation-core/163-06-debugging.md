# 第 163 章：06. Debug / 观察：如何排查“校验为什么没生效？”
<!-- CHAPTER-CARD:START -->
!!! summary "章节学习卡片（五问闭环）"
...
上一章：[第 162 章：05. 自定义约束：如何写一个最小可用的 `@Constraint`？](162-05-custom-constraint.md) ｜ 全书目录：[Book TOC](/book/) ｜ 下一章：[第 164 章：90. 常见坑清单（建议反复对照）](../appendix/164-90-common-pitfalls.md)
<!-- GLOBAL-BOOK-NAV:END -->
