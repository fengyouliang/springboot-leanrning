    ...
    void exercise_toggleableHealthIndicator() {
        assertThat(true)
                .as("""
                        ...
                        参考：
                        - `springboot-actuator/src/test/java/com/learning/springboot/bootactuator/BootActuatorLabTest.java`
    ...
    void exercise_endpointExposure() {
        assertThat(true)
                .as("""
                        ...
                        参考：
                        - `springboot-actuator/src/test/java/com/learning/springboot/bootactuator/BootActuatorExposureOverrideLabTest.java`
                        """)
                .isFalse();
    }
