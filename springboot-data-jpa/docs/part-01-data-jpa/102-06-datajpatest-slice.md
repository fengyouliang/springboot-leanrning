# 第 102 章：06. `@DataJpaTest`：为什么它适合学 JPA（切片测试）
<!-- CHAPTER-CARD:START -->
!!! summary "章节学习卡片（五问闭环）"
...
上一章：[part-01-data-jpa/05-fetching-and-n-plus-one.md](101-05-fetching-and-n-plus-one.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-data-jpa/07-debug-sql.md](103-07-debug-sql.md)
