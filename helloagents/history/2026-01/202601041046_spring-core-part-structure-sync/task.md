...
## 1. spring-core-aop
- [√] 1.1 调整 `spring-core-aop/docs/`：建立 `part-00-guide/`、`part-01-*/`、`appendix/` 并迁移现有章节文件，修复文档内部链接
...
- [√] 1.4 同步修复 `spring-core-aop/docs/**` 中所有源码路径与包名引用
- [√] 1.5 验证：执行 `mvn -pl spring-core-aop test`

## 2. spring-core-events
- [√] 2.1 调整 `spring-core-events/docs/`：补齐 `part-00-guide/00-deep-dive-guide.md`、`appendix/99-self-check.md`，并将现有章节移动到 `part-01-*`，修复链接
...
- [√] 2.4 同步修复 `spring-core-events/docs/**` 中所有源码路径与包名引用
- [√] 2.5 验证：执行 `mvn -pl spring-core-events test`

## 3. spring-core-profiles
- [√] 3.1 新增 `spring-core-profiles/docs/` 书本骨架：`docs/README.md`、`docs/part-00-guide/00-deep-dive-guide.md`、`docs/part-01-*/`、`docs/appendix/90-common-pitfalls.md`、`docs/appendix/99-self-check.md`
...
- [√] 4.1 调整 `spring-core-resources/docs/`：补齐 `part-00-guide/00-deep-dive-guide.md`、`appendix/99-self-check.md`，并将章节移动到 `part-01-*`
...
- [√] 4.4 同步修复 `spring-core-resources/docs/**` 中所有源码路径与包名引用
- [√] 4.5 验证：执行 `mvn -pl spring-core-resources test`

## 5. spring-core-tx
- [√] 5.1 调整 `spring-core-tx/docs/`：补齐 `part-00-guide/00-deep-dive-guide.md`、`appendix/99-self-check.md`，并将章节移动到 `part-01-*`
...
- [√] 5.4 同步修复 `spring-core-tx/docs/**` 中所有源码路径与包名引用
- [√] 5.5 验证：执行 `mvn -pl spring-core-tx test`

## 6. spring-core-validation
- [√] 6.1 调整 `spring-core-validation/docs/`：补齐 `part-00-guide/00-deep-dive-guide.md`、`appendix/99-self-check.md`，并将章节移动到 `part-01-*`
...
- [√] 6.4 同步修复 `spring-core-validation/docs/**` 中所有源码路径与包名引用
