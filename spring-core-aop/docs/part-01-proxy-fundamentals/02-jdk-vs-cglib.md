...
- 代理对象是你的类的 **子类**（通过继承生成）
- 优点：即使没有接口也能代理
- 代价：受到继承规则限制（`final` 类/方法相关，见 [04. final-and-proxy-limits](04-final-and-proxy-limits.md)）
...
上一章：[01-aop-proxy-mental-model](01-aop-proxy-mental-model.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03-self-invocation](03-self-invocation.md)
